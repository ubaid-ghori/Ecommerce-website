  ...
  return (
    <div className="px-20 mt-20">
      ...
      <div className="flex flex-wrap gap-5 mt-10">
        {Data.map((item) => (
          <div
            className="card w-[280px] bg-white rounded-xl shadow-md"
            key={item.id}
          >
            ...
            <div className="px-4 pt-2 flex flex-col gap-2">
              ...
              <p className="text-[#2D2A6E] text-md font-medium">{item.desc}</p>
              <button className="text-[#96AE00] font-semibold pt-2 mb-7 text-left text-md">
                {item.link}
              </button>
            </div>
          </div>
